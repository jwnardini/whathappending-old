  ...
  <header id="header" class="header" role="header">
    ...
    <div class="message-wrap-1 col-sm-6">
      <div class="message-wrap-2">
        ...
        <div class="slogan"> <h1 class="h1">The podcast where we watch only the pilot and series finale and try to guess what happened in-between.</h1></div>
        <div class="slogan-logo">
          <div class="twitter-logo" style="float:left"><a href="http://www.twitter.com/whathappending" target="_blank"><img src="https://cdn1.iconfinder.com/data/icons/logotypes/32/twitter-128.png"><h4 class="logo-text">@whathappending</h4></a></div>
          <div class="facebook-logo" style="float:right"><a href="http://www.facebook.com/whathappending" target="_blank"><img src="https://worldvectorlogo.com/logos/facebook-icon.svg" height="128px"><h4 class="logo-text">WH on Facebook</h4></a></div>
          </div>
      </div>
    </div>
  </header>
...
<footer id="footer" class="footer" role="footer">
  <div class="container">
    ...
    <?php
    $url = "http://live-whathappending.pantheonsite.io/";
